...
const ImageUpload = ({ jsonData,err, setJsonData,validate, name = "image", fileList, setFileList}) => {
    ...
    return (
        <>
            <Upload
                className={err?.image || err?.logo ? "error" : "input-default"}
